...
#if FOR_BELKIN
extern void xmlSetRemoteAdminAttr(FILE* file, const char *appName, const UINT16 id, const PSI_VALUE value, const UINT16 length);
extern PSX_STATUS xmlGetRemoteAdminAttr(char *attrName, char* attrValue);
extern PSX_STATUS xmlStartRemoteAdminObj(char *appName, char *objName);
extern PSX_STATUS xmlEndRemoteAdminObj(char *appName, char *objName);
