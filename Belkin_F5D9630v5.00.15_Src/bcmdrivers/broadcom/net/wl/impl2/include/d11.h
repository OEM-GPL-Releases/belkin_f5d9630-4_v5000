...
#define	MCTL_KEEPBADFRAMES	(1 << 23)
...
/* Mac capabilbities register (machwcap) */
...
/* Antenna diversity field in bbconfig */
...
/* M_HOST_FLAGS */
#define MHFMAX		3 /* Number of defined hostflag words (uint16) */
...
#define MHF3_ANTSEL_EN		0x0001		/* Enable antenna diversity */
#define MHF3_ANTSEL_MODE	0x0002		/* antenna diversity mode: 2x4 (0) or 2x3(1) */
...
#define	PRXS0_RXANT		0x0020	/* NPHY: upper sideband */
