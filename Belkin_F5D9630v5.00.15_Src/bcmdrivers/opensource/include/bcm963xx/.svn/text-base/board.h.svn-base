...
extern "C" {
#endif
#define NVRAM_VERSION_NUMBER_ADDRESS    0     //Alex
/*****************************************************************************/
/*          board ioctl calls for flash, led and some other utilities        */
/*****************************************************************************/
//alex add for ralink_ses 2007.7.3
#define RALINK_WPS_ENABLE			123
...
//dumas
#define BOARD_IOCTL_SET_COUNTRY         _IOWR(BOARD_IOCTL_MAGIC, 27, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_COUNTRY         _IOWR(BOARD_IOCTL_MAGIC, 28, BOARD_IOCTL_PARMS)

//Alex add for ralink_ses 2007.7.3
#define BOARD_IOCTL_RALINK_WPS      	 _IOWR(BOARD_IOCTL_MAGIC, 29, BOARD_IOCTL_PARMS)    

//Alex add for Belkin WPS default PIN
#define BOARD_IOCTL_GET_SN     			_IOWR(BOARD_IOCTL_MAGIC, 30, BOARD_IOCTL_PARMS) 
#define BOARD_IOCTL_SET_SN     			_IOWR(BOARD_IOCTL_MAGIC, 31, BOARD_IOCTL_PARMS)
...
void kerSysCountryGet(char *value); //dumas
void kerSysCountrySet(char *string, int size, int offset); //dumas
//Add by Alex : for Belkin WPS default PIN
extern void kerSysGetSN(char* SerialNumber);
extern void kerSysSetSN(char* SerialNumber); 
//Add end
